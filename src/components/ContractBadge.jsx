...
export default function ContractBadge({ contractEnd, status }) {
 ...
 <span style={{ display: 'inline-flex', alignItems: 'center', padding: '3px 8px', borderRadius: '4px', fontSize: '11px', fontWeight: 600, background: 'rgba(220,38,38,0.08)', color: '#DC2626' }}>
 Kontrak berakhir {Math.abs(days)} hari lalu
 </span>
 </div>
 );
 }
