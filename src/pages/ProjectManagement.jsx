...
export default function ProjectManagement() {
 ...
 <button onClick={() => setModal(null)} className="modal-close"><FiX size={18} /></button>
 </div>
 ...
 <textarea className="form-textarea" rows={3} value={form.description} onChange={e => setForm({ ...form, description: e.target.value })} placeholder="Deskripsi proyek" />
 </div>
 ...
 <div className="form-group">
 <label className="form-label">Tarif per Jam (Rp)</label>
 ...
 <input type="color" value={form.color} onChange={e => setForm({ ...form, color: e.target.value })} style={{ width: '100%', height: 42, border: '1.5px solid var(--border)', borderRadius: 'var(--radius-md)', cursor: 'pointer', background: 'var(--bg)' }} />
 </div>
 </div>
 </div>
 ...
 <select className="form-select" value={assignForm.role} onChange={e => setAssignForm({ ...assignForm, role: e.target.value })}>
